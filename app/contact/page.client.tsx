            ...
            <Reveal>
              <div className='border-t border-cream/15 pt-6'>
                <ContactRow
                  n='01'
                  label='reserve'
                  value='hello@loveatfirstsight.co'
                  href='mailto:hello@loveatfirstsight.co'
                />
                <ContactRow
                  n='02'
                  label='apply to cook'
                  value='chefs@loveatfirstsight.co'
                  href='mailto:chefs@loveatfirstsight.co'
                />
                <ContactRow
                  n='03'
                  label='press'
                  value='press@loveatfirstsight.co'
                  href='mailto:press@loveatfirstsight.co'
                />
                <ContactRow
                  n='04'
                  label='reply time'
                  value='within one evening'
                />
              </div>
            </Reveal>
          </div>
...
function ContactRow({
    ...
    <div className='border-b border-cream/15 h-[84px] flex flex-col justify-center'>
      <div className='grid grid-cols-[auto_minmax(0,1fr)] items-baseline gap-4 md:gap-6'>
        ...
        <div className='min-w-0'>
          ...
          <div className='mt-1 font-display font-bold text-lg md:text-xl lowercase text-cream truncate'>
            {value}
          </div>
        </div>
      </div>
  ...
  return href ? (
    <a href={href} className='block hover:text-cream transition-colors'>
      {inner}
    </a>
  ) : (
    <div>{inner}</div>
